...
- Defines `const string IDENTIFIER = 'iwf.ruleName'`
...
- Test data in `tests/data/` — PHP files with `// @error iwf.ruleIdentifier` annotations on lines that should trigger errors
